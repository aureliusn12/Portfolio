...
const MatrixBackground = () => {
  useEffect(() => {
    ...
    const draw = () => {
      // Criar efeito de fade com fundo semi-transparente - MAIS LENTO
...
export default function Portfolio() {
  ...
  return (
    <div className="bg-black text-white min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-b from-black/10 via-transparent to-black/20 pointer-events-none z-[1]" />

      {/* Todo o resto do conteúdo com z-index maior */}
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="scroll-animate slide-in-left">
                ...
                <p className="text-gray-300 mb-8 leading-relaxed scroll-animate fade-in animation-delay-200">
                  Estou sempre aberto a novos projetos e oportunidades. Se você tem uma ideia incrível ou precisa de
